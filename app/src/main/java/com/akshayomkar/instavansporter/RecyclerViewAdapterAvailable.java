 ...
 */
public class RecyclerViewAdapterAvailable extends RecyclerView.Adapter<RecyclerViewAdapterAvailable.RecyclerViewHolder>{

    private static final String TAG = "RecyclerViewAdapterAvailable";
    ...
    public RecyclerViewAdapterAvailable(Context context, ArrayList<Job> list){
